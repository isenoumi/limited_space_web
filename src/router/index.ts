...
export const constantRoutes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    component: () => import("@/views/h5Table/noticeBoard/index.vue"),
    meta: { hidden: true },
  },
  //noticeBoard
  {
    path: "/manageTable",
    component: () => import("@/views/h5Table/manage/index.vue"),
    meta: { hidden: true },
  },
  //首页
  {
    ...
    children: [
      {
        ...
        component: () => import("@/views/identificationLedger/ledgerFilling/index.vue"),
      ...
      },
      {
        ...
        component: () => import("@/views/common/enterpriseStatistics.vue"),
        meta: { hidden: true },
      },
      {
        path: "countyStatistics",
        component: () => import("@/views/common/countyStatistics.vue"),
        meta: { hidden: true },
      },
      {
        path: "enterpriseStatisticsSelf",
        component: () => import("@/views/common/enterpriseStatisticsSelf.vue"),
        meta: { hidden: true },
      },
      {
        path: "countyStatisticsSelf",
        component: () => import("@/views/common/countyStatisticsSelf.vue"),
        meta: { hidden: true },
      },
      {
        path: "viewEnterpriseLedger",
        component: () => import("@/views/identificationLedger/ledgerFilling/components/viewEnterpriseLedger.vue"),
        meta: { hidden: true },
      },
    ],
  },
  ...
  // 作业台账
  {
    ...
    children: [
      {
        path: "temporaryStorageRecords",
        component: () => import("@/views/homeworkLedger/temporaryStorageRecords/index.vue"),
        meta: { hidden: true },
      },
      {
        path: "homeworkRecords",
        component: () => import("@/views/homeworkLedger/homeworkRecords/index.vue"),
        meta: { hidden: true },
      },
    ],
  },
  // 自查台账
  {
    ...
    children: [
      {
        path: "ledgerViewing",
        component: () => import("@/views/inspectionLedger/ledgerViewing/index.vue"),
        meta: { hidden: true },
      },
    ],
  },
