...
export function getMyProjectInfoPage(params: any) {
    return request({
        url: '/yx-project/api/project/myProjectMessage',
        method: 'get',
        params: params,
        paramsSerializer: function (params) {
            return qs.stringify(params, { arrayFormat: 'repeat' })
...
export function projectDel(data: any) {
    return request({
        url: `/yx-project/api/project?id=${data}`,
        method: 'delete',
        // data: data
    });
}
...
export function projectSelectPost(data: any) {
    return request({
        url: `/yx-project/api/project/projectDetails?id=${data}`,
        method: 'get',
        // param: data
    });
}
