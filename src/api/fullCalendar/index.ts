...
export function getFullCalendarPlan(params: any) {
    return request({
        url: '/yx-project/api/project_plan_item/list/calendar',
        method: 'get',
        params
    });
}
...
export function getFullCalendarPlanAll(params: any) {
    return request({
        url: '/yx-project/api/project_plan_item/list/project/calendar',
        method: 'get',
        params
    });
}
...
export function getDailyPaper(params: any) {
    ...
    return request({
        url: '/yx-project/api/daily_paper',
        method: 'get',
        params
    });
}
...
export function getUserList() {
    return request({
        url: '/yx-sys/api/user/userDepartmentList',
        method: 'get',
    });
}
...
export function postDailyRemark(params: any) {
    return request({
        url: '/yx-project/api/dailyComment/dailyCommentInsert',
        method: 'post',
        data: params,
    });
}
...
export function getDailyRemark(params: any) {
    return request({
        url: '/yx-project/api/dailyComment/page',
        method: 'get',
        params,
    });
}
...
export function getDailyRemarkById(params: any) {
    return request({
        url: `/yx-project/api/dailyComment/${params}`,
        method: 'get',
    });
}
/**
...
export function exportDailyPaper(params: any) {
    return request({
        url: 'yx-project/api/daily_paper/outExcel',
        method: 'post',
        params,
        responseType: 'blob',
    });
