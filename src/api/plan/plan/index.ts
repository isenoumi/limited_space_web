...
export function getPlanPage(params: any) {
    return request({
        url: '/yx-project/api/t_project_plan',
        method: 'get',
        params: params,
    });
}
...
export function getPlanOne(params: any) {
    return request({
        url: `/yx-project/api/t_project_plan/${params}`,
        method: 'get',
        // params: params
    });
}
...
export function getSubtaskById(data: any) {
    return request({
        url: `/yx-project/api/project_plan_item/${data}/list`,
        method: 'get',
        // data: data
    });
}
...
export function getSubPlanPage(data: any) {
    return request({
        url: `/yx-project/api/project_plan_item`,
        method: 'get',
        params: data
    });
}
...
export function biddingEdit(data: any) {
    return request({
        url: '/yx-project/api/Tenders/edit',
        method: 'post',
        data: data
    });
}
...
export function delPlan(data: any) {
    return request({
        url: `/yx-project/api/project_plan_item/${data}`,
        method: 'delete',
        // data: data
    });
}
...
export function subTaskUpdateList(data: any) {
    return request({
        url: `/yx-project/api/project_plan_item/updateList`,
        method: 'post',
        data: data
    });
}
