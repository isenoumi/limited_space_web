...
export function getFeishuApprovalDetails(params: any) {
    return request({
        url: `/yx-project/api/Feishu/approvalDetails/${params}`,
        method: 'get',
        params: params
    });
}
...
export function createFeishuUpload(params: any) {
    return request({
        url: '/yx-project/api/Feishu/upload',
        method: 'post',
        data: params,
        headers: {
            'Content-Type': 'multipart/form-data;'
...
export function getFeishuApprovalDictionary(params: any) {
    return request({
        url: '/yx-project/api/Feishu/feishuApprovalDictionary',
        method: 'get',
        params: params
    });
}
...
export function downloadFile(params: any) {
    return request({
        url: `/yx-project/api/file/download`,
        method: 'post',
        data: params,
