...
export function getProjectBudget(params: any) {
    return request({
        url: '/yx-project/api/ProjectBudget/budgetDtoListlistbyuse',
        method: 'get',
        params: params
    });
}
...
export function getbyparentid(id: any) {
    return request({
        url: '/yx-project/api/ProjectBudget/' + id,
        method: 'get',
        // params: params
    });
}
...
export function getProjectBudgetbyparentid(params: any) {
    return request({
        url: '/yx-project/api/ProjectBudget/byparentid',
        method: 'get',
        params: params
    });
}
...
export function budgetSubject(id: any) {
    return request({
        url: '/yx-project/api/budgetSubject/' + id,
        method: 'delete',
        // data: data
    });
}
...
export function getitemname(id: string) {
    return request({
        url: '/yx-project/api/budgetSubject/getitemname?parentId=' + id,
        method: 'get',
        // params: id
    });
}
...
export function getbudgetExamine(params: any) {
    return request({
        url: '/yx-project/api/budgetExamine/page',
        method: 'get',
        params: params
    });
}
...
export function getNotNullMonth(id: any) {
    return request({
        url: '/yx-project/api/budgetExamine/getNotNullMonth?budgetSubjectId=' + id,
        method: 'get',
        // params: params
    });
}
...
export function budgetExamine(params: any) {
    return request({
        url: '/yx-project/api/budgetExamine/getMonthBudget',
        method: 'get',
        params: params
    });
}
...
export function getinsert(data: any) {
    return request({
        url: '/yx-project/api/budgetExamine/insert',
        method: 'post',
        data: data
    });
}
...
export function getprojectselect(params: any) {
    return request({
        url: '/yx-project/api/project/projectDetails',
        method: 'get',
        params: params
    });
}
...
// export function getprojectselect(params: any) {
//     return request({
//         url: '/yx-project/api/t_approva_instance',
//         method: 'get',
//         params: params
//     });
// }
...
export function getSubPlanPage(data: any) {
    return request({
        url: `/yx-project/api/yx-project/api/budgetSubject/importExcel`,
        method: 'post',
        params: data
    });
}
...
export function getfeishuCreatesAnApproval(params: any) {
    return request({
        url: `/yx-project/api/Feishu/feishuCreatesAnApproval`,
        method: 'post',
        data: params,
        headers: {
...
export function getbudgetSubject(data: any) {
    return request({
        url: `/yx-project/api//budgetSubject/edite`,
        method: 'post',
        data: data
    });
}
...
export function getaddbudgetSubject(data: any) {
    return request({
        url: `/yx-project/api/budgetSubject`,
        method: 'post',
        data: data
    });
}
...
export function getselectExamineTypeEnums() {
    return request({
        url: `/yx-project/api/budgetExamine/selectExamineTypeEnums`,
        method: 'get',
        // params: data
    });
}
...
export function getselectContractTypeEnums() {
    return request({
        url: `/yx-project/api/budgetExamine/selectContractTypeEnums`,
        method: 'get',
        // params: data
    });
}
...
export function getselectPaymentWayEnums() {
    return request({
        url: `/yx-project/api/budgetExamine/selectPaymentWayEnums`,
        method: 'get',
        // params: data
    });
}
...
export function getselectReimbursementTypeEnums() {
    return request({
        url: `/yx-project/api/budgetExamine/selectReimbursementTypeEnums`,
        method: 'get',
        // params: data
    });
}
...
export function getpagebyExamineId(data: any) {
    return request({
        url: `/yx-project/api/budgetReimbursement/pagebyExamineId`,
        method: 'get',
        params: data
    });
}
...
export function getisupperLimit(data: any) {
    return request({
        url: `/yx-project/api/ProjectBudget/isupperLimit`,
        method: 'post',
        params: data
    });
}
...
export function getlevel1Subjects(data: any) {
    return request({
        url: `/yx-project/api/contract/level1Subjects`,
        method: 'get',
        params: data
    });
}
...
export function getlevel2Subjects(data: any) {
    return request({
        url: `/yx-project/api/contract/level2Subjects`,
        method: 'get',
        params: data
    });
}
...
export function getlistExamineRecord(data: any) {
    return request({
        url: `/yx-project/api/budgetExamine/listExamineRecord`,
        method: 'get',
        params: data
    });
}
...
export function getbudpage(data: any) {
    return request({
        url: `/yx-project/api/budgetSubject/${data.id}`,
        method: 'get',
        // params: data
    });
}
...
export function getsubmitFeeApply(data: any) {
    return request({
        url: `/yx-project/api/budgetExamine/submitFeeApply`,
        method: 'post',
        data: data
    });
}
...
export function postReimbursementOfReserves(data: any) {
    return request({
        url: `/yx-project/api/budgetExamine/reimbursementOfReserves`,
        method: 'post',
        data: data
    });
}
...
export function getsubmitNonContractualFeeApply(data: any) {
    return request({
        url: `/yx-project/api/budgetExamine/submitNonContractualFeeApply`,
        method: 'post',
        data: data
    });
}
...
export function getSubjectStatistic(data: any) {
    return request({
        url: `/yx-project/api/budgetSubject/getSubjectStatistic`,
        method: 'get',
        params: data
    });
}
...
export function getupdateSubjectPrice(data: any) {
    return request({
        url: `/yx-project/api/budgetSubject/updateSubjectPrice`,
        method: 'post',
        data: data
    });
}
...
export function getlevelAllThreeSubjects(data: any) {
    return request({
        url: `/yx-project/api/budgetSubject/levelAllThreeSubjects`,
        method: 'get',
        params: data
    });
}
...
export function getlistContractByProjectId(data: any) {
    return request({
        url: `/yx-project/api/contract/listContractByProjectId`,
        method: 'get',
        params: data
    });
}
...
export function getlistSubjectByContractId(data: any) {
    return request({
        url: `/yx-project/api/budgetSubject/listSubjectByContractId`,
        method: 'get',
        params: data
    });
}
...
export function getsubmitContractualFeeApply(data: any) {
    return request({
        url: `/yx-project/api/budgetExamine/submitContractualFeeApply`,
        method: 'post',
        data: data
    });
}
...
export function getheOperationRecordIsDisplayed(params: any) {
    return request({
        url: `/yx-project/api/budgetExamine/theOperationRecordIsDisplayed`,
        method: 'get',
        params
    });
}
...
export function getaccountAmountModification(data: any) {
    return request({
        url: `/yx-project/api/budgetExamine/accountAmountModification`,
        method: 'get',
        params: data
    });
}
...
export function getqueryAccountInformation(data: any) {
    return request({
        url: `/yx-project/api/budgetExamine/queryAccountInformation`,
        method: 'get',
        params: data
    });
}
...
export function getgetId(data: any) {
    return request({
        url: `yx-project/api/budgetExamine/getId?id=${data}`,
        method: 'get'
    });
}
...
export function gettheEndExamine(data: any) {
    return request({
        url: `/yx-project/api/budgetExamine/theEndExamine?id=${data}`,
        method: 'post',
        // data:data
    });
}
