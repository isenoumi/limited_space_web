...
export function getTaskNoticePage(params: any) {
    return request({
        url: '/yx-project/api/Message/list',
        method: 'get',
        params: params
    });
}
...
export function getTaskNoticeDetailsProject(params: any) {
    return request({
        url: `/yx-project/api/project_plan_item/particulars/${params}`,
        method: 'get',
        // params: params
    });
}
...
export function getBudgetNoticeDetailsProject(params: any) {
    return request({
        url: `/yx-project/api/ProjectBudget/byhaveOne`,
        method: 'get',
        params: params
    });
}
...
export function setReadStatus(params: any) {
    return request({
        url: `/yx-project/api/Message/updateStatus`,
        method: 'get',
        params: params
    });
}
