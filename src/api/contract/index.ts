...
export function getContractPage(params: any) {
    return request({
        url: '/yx-project/api/contract/page',
        method: 'get',
        params: params,
...
export function contractDel(data: any) {
    return request({
        url: `/yx-project/api/contract/${data}`,
        method: 'delete',
        // data: data
    });
}
...
export function createContractPost(params: any) {
    return request({
        url: `/yx-project/api/contract/contractInsert`,
        method: 'post',
        data: params
    });
}
...
export function levelThreeSubjects(params: any) {
    return request({
        // url: `/yx-project/api/contract/level3Subjects`,
        url: `/yx-project/api/contract/updatelevel3Subjects`,
        method: 'get',
        params
    });
}
...
export function getContractInfo(params: any) {
    return request({
        url: `/yx-project/api/contract/${params}`,
        method: 'get',
    });
}
/**
...
export function createChangeContract(params: any) {
    return request({
        url: `/yx-project/api/contract/contractupdate`,
        method: 'post',
        data: params,
    });
}
...
export function getChangeContract(params: any) {
    return request({
        url: `/yx-project/api/contract/selectSonContract`,
        method: 'get',
        params,
    });
}
