! function (e, n) {
	...
	if (!r.jWeixin) return a = {
			...
			for (e in a) n[a[e]] = e;
			return n
		}(), n = r.document, i = n.title, t = navigator.userAgent.toLowerCase(), f = navigator.platform.toLowerCase(),
		o = !(!f.match("mac") && !f.match("win")), s = -1 != t.indexOf("wxdebugger"), d = -1 != t.indexOf(
			"micromessenger"), l = -1 != t.indexOf("android"), u = -1 != t.indexOf("iphone") || -1 != t.indexOf(
			"ipad"), p = (f = t.match(/micromessenger\/(\d+\.\d+\.\d+)/) || t.match(
			...
			scanQRCode: function (e) {
				k("scanQRCode", {
					...
					var n;
					u && (n = e.resultStr) && (n = JSON.parse(n), e.resultStr = n && n.scan_code &&
						n.scan_code.scan_result)
				}, e))
			},
			openAddress: function (e) {
				k(a.openAddress, {}, (e._complete = function (e) {
					(e = e).postalCode = e.addressPostalCode, delete e.addressPostalCode, e.provinceName =
						e.proviceFirstStageName, delete e.proviceFirstStageName, e.cityName = e
						.addressCitySecondStageName, delete e.addressCitySecondStageName, e.countryName =
						e.addressCountiesThirdStageName, delete e.addressCountiesThirdStageName,
			...
			launchMiniProgram: function (e) {
				k("launchMiniProgram", {
					...
					path: function (e) {
						var n;
						if ("string" == typeof e && 0 < e.length) return n = e.split("?")[0], n +=
							".html", void 0 !== (e = e.split("?")[1]) ? n + "?" + e : n
					}(e.path),
			...
			l || (t = (n = e.target).tagName, i = n.src, "IMG" != t && "VIDEO" != t && "AUDIO" != t &&
				"SOURCE" != t) || -1 != i.indexOf("wxlocalresource://") && (e.preventDefault(), e.stopPropagation(),
				(t = n["wx-id"]) || (t = w++, n["wx-id"] = t), T[t] || (T[t] = !0, wx.ready(function () {
					wx.getLocalImgData({
						localId: i,
						success: function (e) {
							n.src = e.localData
			...
			var n;
			l || (n = (e = e.target).tagName, e.src, "IMG" != n && "VIDEO" != n && "AUDIO" != n && "SOURCE" !=
				n) || (n = e["wx-id"]) && (T[n] = !1)
	...
	function P(e) {
		return (e = e || {}).appId = h.appId, e.verifyAppId = h.appId, e.verifySignType = "sha1", e.verifyTimestamp =
			h.timestamp + "", e.verifyNonceStr = h.nonceStr, e.verifySignature = h.signature, e
	}
	...
	function V(e, n, i) {
		...
		var t = n.errMsg,
			e = (t || (t = n.err_msg, delete n.err_msg, t = function (e, n) {
					...
					i = "ok"; {
						var t;
						n && (t = n.indexOf(":"), "access denied" != (i = (i = (i = -1 != (i = -1 != (i =
								"failed" == (i = "confirm" == (i = n.substring(t + 1)) ?
									"ok" : i) ? "fail" : i).indexOf("failed_") ? i.substring(
								7) : i).indexOf("fail_") ? i.substring(5) : i).replace(/_/g, " ")).toLowerCase()) &&
							"no permission to execute" != i || (i = "permission denied"), "" == (i =
								"config" == e && "function not exist" == i ? "ok" : i)) && (i = "fail")
					}
					return n = e + ":" + i
				}(e, t), n.errMsg = t), (i = i || {})._complete && (i._complete(n), delete i._complete), t = n.errMsg ||
				"", h.debug && !i.isInnerInvoke && alert(JSON.stringify(n)), t.indexOf(":"));
	...
	function C(e, n) {
		var i;
		!h.debug || n && n.isInnerInvoke || ((i = c[e]) && (e = i), n && n._complete && delete n._complete, console
			.log('"' + e + '",', n || ""))
	}

	function B(n) {
		var i;
		o || s || h.debug || p < "6.0.2" || g.systemType < 0 || (i = new Image, g.appId = h.appId, g.initTime = m.initEndTime -
			m.initStartTime, g.preVerifyTime = m.preVerifyEndTime - m.preVerifyStartTime, _.getNetworkType({
				isInnerInvoke: !0,
				success: function (e) {
					g.networkType = e.networkType;
					e = "https://open.weixin.qq.com/sdk/report?v=" + g.version + "&o=" + g.isPreVerifyOk +
						"&s=" + g.systemType + "&c=" + g.clientVersion + "&a=" + g.appId + "&n=" + g.networkType +
						"&i=" + g.initTime + "&p=" + g.preVerifyTime + "&u=" + g.url + "&jsapi_name=" +
						(n ? n.jsApiName : "");
					i.src = e
				}
			}))
