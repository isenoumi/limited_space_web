<template>
  <div class="app-container">
    ...
    <el-card shadow="never">
      ...
      <el-table ref="dataTableRef" v-loading="loading" :data="roleList" highlight-current-row border @selection-change="handleSelectionChange">
        <el-table-column label="角色名称" prop="name" min-width="100" align="center" />
        <el-table-column label="角色编码" prop="code" width="250" align="center" />
        <el-table-column label="创建时间" prop="createTime" width="250" align="center" />
        <el-table-column label="备注" prop="description" width="250" align="center" />
        <el-table-column label="状态" align="center" width="100">
          <template #default="scope">
            <el-tag v-if="(scope.row.showFlag = true)" type="success">正常</el-tag>
        ...
        <el-table-column fixed="right" label="操作" width="320" align="center">
          <template #default="scope">
            ...
            <el-button type="primary" size="small" link @click="openDialog(scope.row.id, scope.row)">
              <i-ep-edit />编辑
            </el-button>
    ...
    <el-dialog v-model="menuDialogVisible" :title="'【' + checkedRole.name + '】权限分配'" width="800px">
      <el-scrollbar v-loading="loading" max-height="600px">
        ...
        <el-tree :check-strictly="isCheck.show" ref="menuRef" node-key="id" show-checkbox :data="menuList" :default-expand-all="true" :default-checked-keys="defaultPermTreeSelect">
