<template>
  <el-card v-loading="loading">
    <div class="title">区县有限空间辨识台账统计</div>
    <div class="main">
      <div class="left">
        <div class="search">
        ...
        <div class="complete">
          ...
          <div class="list">
            <el-table :data="completeTableData" style="width: 100%" @row-click="rowClick">
              ...
              <el-table-column prop="countiesName" align='center' label="名称" width="140" />
              ...
              <el-table-column prop="companiesNum" align='center' label="企业数量" width="80" />
              <el-table-column prop="spacesTotal" align='center' label="有限空间数量" width="120" />
            </el-table>
          </div>
        </div>
        <!-- <div class="complete">
          ...
          <div class="list">
            <el-table :data="incompleteTableData" style="width: 100%">
              ...
              <el-table-column prop="name" align='center' label="有限空间数量" width="120" />
            </el-table>
          </div>
        </div> -->
...
<script setup>
  import { getColumnarList } from "./api"
  ...
  const rowClick = (row) => {
    router.push({
      path: "/enterpriseStatistics",
      query: { companyId: row.countiesName },
    })
  }
  ...
  const queryList = () => {
    ...
    getColumnarList({
      ...
      completeTableData.value.map((item) => {
        x.value.push(item.countiesName)
