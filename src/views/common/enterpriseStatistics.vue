<template>
  <el-card v-loading="loading">
    <div class="title">企业有限空间辨识台账统计</div>
    <div class="main">
      <div class="left">
        <div class="search">
          <!-- <div class="item">
        ...
        <div class="complete">
          ...
          <div class="list">
            <el-table :data="completeTableData" style="width: 100%">
              ...
              <el-table-column prop="kongjianshu" align='center' label="有限空间数量" width="120" />
            </el-table>
          </div>
        </div>
        <div class="complete">
...
<script setup>
  import { getLedgerStatisticsList } from "./api"
  ...
  const completeTableData = ref([{ enterpriseName: "丰川祥子", kongjianshu: 17 }])
  const incompleteTableData = ref([
    { enterpriseName: "长崎素世", kongjianshu: 17 },
  ])
  const view = (type) => {}
  const back = () => {
    router.back()
