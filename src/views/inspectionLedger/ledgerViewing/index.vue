    ...
    <div class="searchBox">
      <div class="headerSelect">
        ...
        <div class="inputBox" v-if="isCity||isCounty">
          ...
          <el-input v-model="searchForm.companyName" class="input" clearable placeholder="请输入单位名称">
          </el-input>
      ...
      <div class="btnList">
        ...
        <el-button v-if="isEnterprise" type="primary" @click="downloadExamination">下载自查表</el-button>
        <el-button v-else type="primary" @click="statistics">台账统计</el-button>
      </div>
    </div>
...
<script setup>
  ...
  const downloadExamination = () => {
    const formData = new FormData()
    const fileUrl =
      "https://oms.cestech.com.cn/file/255207a432584003832393225660b2bb.docx"
