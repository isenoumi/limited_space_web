      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label-width="140px" label="地下有限空间" prop="limitedSpaceUnderground">
            <el-input type="number" disabled v-model="formData.limitedSpaceUnderground" placeholder="请输入地下有限空间" clearable></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label-width="140px" label="地上有限空间" prop="limitedSpaceAboveGround">
            <el-input type="number" disabled v-model="formData.limitedSpaceAboveGround" placeholder="请输入地上有限空间" clearable></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item label-width="140px" label="密闭设备数" prop="confinedDevices">
            <el-input type="number" disabled v-model="formData.confinedDevices" placeholder="请输入密闭设备数" clearable></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
...
<script setup>
  ...
  import { county_insert, county_edit } from "../api/county"
  ...
  const handleConfirm = () => {
    form.value.validate((valid) => {
      if (!valid) return
      if (props.type == "新建") {
        county_insert(formData.value).then((res) => {
          if (res.code === 200) {
        ...
        county_edit(formData.value).then((res) => {
          if (res.code === 200) {
            ElMessage.success(res.msg)
            close()
          }
