<template>
  <div class="app-container">
    <el-card>
      <div class="header">
        <div class="headInput">
          ...
          <el-input v-model="query.clientName" placeholder="请输入客户名称" class="input"></el-input>
        </div>
        <div class="headInput">
          ...
          <!-- <el-input
            ...
            class="input"
          ></el-input> -->
          <el-select filterable v-model="query.salesPersonnel" placeholder="请选择销售人员" clearable>
        ...
        <div class="headInput">
          ...
          <el-input v-model="query.linkman" placeholder="请输入客户联系人" class="input"></el-input>
        </div>
        <div class="headSelect">
          <div class="title">所属区域:</div>
          <el-cascader v-model="query.address" :options="cityData" :props="cityProps" ref="cascaderAddr" placeholder="请选择省市区" clearable></el-cascader>
        </div>
        <div class="btnList" style="display: flex; justify-content: right">
          <el-button type="primary" @click="queryList">查询 </el-button>
          <el-button type="primary" @click="reset">重置</el-button>
          <el-button v-hasPerm="['CLIENT_VISIT_ADD']" type="primary" @click="handleAddCustomerVisit" style="margin-right: 10px">
            新增客户
          </el-button>
          <!-- <fileUpload
            :label="'导入客户'"
            action-url="/yx-project/api/project/customerProfileImport"
      ...
      <div class="main">
        <el-table :data="cumstomerTableData" border style="width: 100%" @expand-change="expandChange" :row-key="getRowKeys" :expand-row-keys="expands" v-loading="loading">
          <el-table-column type="expand">
            <template #default="props">
              <div class="subTable">
                <projectTable :id="projectTableId" :table-data="projectTableData" @reset="reset"></projectTable>
              </div>
            </template>
          </el-table-column>
          ...
          <el-table-column align="center" label="客户名称" prop="clientName">
            <template #default="scope">
              <el-tooltip class="box-item" effect="dark" :content="scope.row.clientName" placement="top-start">
                {{
          ...
          <el-table-column align="center" label="客户联系人" prop="customerContacts">
            <template #default="scope">
              {{ scope.row.linkman ? scope.row.linkman + "..." : "" }}
            </template>
          </el-table-column>
          <el-table-column align="center" label="联系人职务" prop="contactPosition">
            <template #default="scope">
              {{
          ...
          <el-table-column align="center" label="销售人员" prop="salesPersonnel">
            <!-- <template #default="scope">
              <div
          ...
          <el-table-column align="center" label="操作" width="360">
            <template #default="scope">
              <el-button v-hasPerm="['CLIENT_VISIT_EDIT']" text type="primary" @click="handleCustomerEdit(scope.row)">
                编辑
              </el-button>
              <el-button v-hasPerm="['CLIENT_VISIT_DETAIL_VISIT']" text type="primary" @click="handleVisit(scope.row)">
                客户拜访
              </el-button>
              <el-button v-hasPerm="['CLIENT_VISIT_DETAIL_PROJECT']" text type="primary" @click="handleAddProject(scope.row)">
                新建项目
              </el-button>
              <el-button v-hasPerm="['CLIENT_VISIT_DELETE']" text type="danger" @click="handleDelete(scope.row)">
                删除
              </el-button>
            </template>
          </el-table-column>
    ...
    <div v-if="addProjectVisible">
      <addProject :id="projectTableId" v-model="addProjectVisible" :formData="projectFormData" :type="projectUpdateType" :customerName="customerName" @reset="reset"></addProject>
    </div>
    <div v-if="addCustomerVisible">
      <addCustomer :id="custmoerId" v-model="addCustomerVisible" :formData="customerFormData" @reset="reset"></addCustomer>
    </div>
    <div v-if="projectInfoVisible">
      <addVisit :clientVisitId="clientVisitId" :type="visitType" v-model="projectInfoVisible" @reset="reset"></addVisit>
    </div>
  </div>
</template>
<!-- 图标选择器示例 -->
